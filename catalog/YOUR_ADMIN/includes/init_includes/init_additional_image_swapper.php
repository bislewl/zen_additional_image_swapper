...
$module_constant = 'ADDITIONAL_IMAGE_SWAPPER_VERSION'; // This should be a UNIQUE name followed by _VERSION for convention
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/additional_image_swapper'; // This is the directory your installer is in, usually this is lower case
$module_name = "Additional Image Swapper"; // This should be a plain English or Other in a user friendly way
